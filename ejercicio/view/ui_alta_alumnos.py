...
################################################################################
## Form generated from reading UI file 'alta_alumnosutfEGe.ui'
##
...
class Ui_alumnos(object):
    def setupUi(self, alumnos):
        ...
        self.formLayout_2.setWidget(0, QFormLayout.LabelRole, self.vcLblNombre)
        ...
        self.formLayout_2.setWidget(0, QFormLayout.FieldRole, self.vcTxtNombre)

        self.vcLblApell = QLabel(alumnos)
        self.vcLblApell.setObjectName(u"vcLblApell")
        self.vcLblApell.setFont(font1)

        self.formLayout_2.setWidget(1, QFormLayout.LabelRole, self.vcLblApell)
        ...
        self.formLayout_2.setWidget(1, QFormLayout.FieldRole, self.vcTxtApell)

        self.vcLblDni = QLabel(alumnos)
        self.vcLblDni.setObjectName(u"vcLblDni")
        self.vcLblDni.setFont(font1)

        self.formLayout_2.setWidget(2, QFormLayout.LabelRole, self.vcLblDni)
        ...
        self.formLayout_2.setWidget(5, QFormLayout.LabelRole, self.vcLblTutor)
        ...
        self.formLayout_2.setWidget(5, QFormLayout.FieldRole, self.vcTxtTutor)

        self.verticalSpacer_5 = QSpacerItem(456, 13, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.formLayout_2.setItem(7, QFormLayout.FieldRole, self.verticalSpacer_5)
